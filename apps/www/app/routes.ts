...
export default [
  route("", "routes/_layout.tsx", [
    ...
    route("artifacts", "routes/artifacts/list.tsx"),
    route("artifacts/new", "routes/artifacts/new.tsx"),
    route("artifacts/:id", "routes/artifacts/view.tsx"),
    route("artifacts/:id/edit", "routes/artifacts/edit.tsx"),
  ]),
