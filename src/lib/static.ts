...
I have been working professionally [since 2012](${linkedin}) (*damn has it been that long?* 😥), working in small and big companies in Santo Domingo, Austin, Stockholm and now Berlin. Originally I started my career in the .NET stack (along many other Microsoft technologies), these days I do most of my work in [typescript](typescriptlang.org) (and js in general). Some tools/technologies I'm interested in: typescript, node, docker, k8s, jamstack, serverless.
